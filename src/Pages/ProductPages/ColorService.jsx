  ...
  return (
    <div style={{ paddingTop: 5 }}>
      <header>
        ...
        <h1>How it works</h1>
        <p>Learn about our color service process</p>
      </header>
      ...
      <main>
        <section className="steps" style={{ paddingTop: 50 }}>
          ...
          <div className="step" onClick={() => alert('Step 3: Service')}>
            ...
            <p>Our expert team will assist you with color selection</p>
