    ...
    <div style={{ paddingTop: 5 }}>
      <header>
        ...
        <Container maxW="full" p={4}>
          ...
          >
            <Box>
              <Heading>Electric Service</Heading>
            </Box>
            <Box>
              <ES />
            </Box>
        ...
        <h1>How it works</h1>
        <p>Learn about our electric service process</p>
      </header>
      ...
      <main>
        <section className="steps" style={{ paddingTop: 50 }}>
          ...
          <div className="step" onClick={() => alert('Step 3: Service')}>
            ...
            <p>Our expert electricians will arrive to assist you</p>
          </div>
          <br />
