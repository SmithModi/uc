    ...
    <div style={{ paddingTop: 5 }}>
      <header>
        ...
        <Container maxW="full" p={4}>
          ...
          >
            <Box>
              <Heading>All Electronics Service</Heading>
            </Box>
            <Box>
              <AES />
            </Box>
        ...
        <h1>How it works</h1>
        <p>Learn about our all electronics service process</p>
      </header>
      ...
      <main>
        <section className="steps" style={{ paddingTop: 50 }}>
          ...
          <div className="step" onClick={() => alert('Step 3: Service')}>
            ...
            <p>Our expert technicians will assist you</p>
...
export default AllElectronicsService;
