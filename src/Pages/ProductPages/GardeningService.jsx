    ...
    <div style={{ paddingTop: 5 }}>
      <header>
        ...
        <Container maxW="full" p={4}>
          ...
          >
            <Box>
              <Heading>Gardening Service</Heading>
            </Box>
            <Box>
              <GS />
            </Box>
        ...
        <h1>How it works</h1>
        <p>Learn about our Gardening service process</p>
      </header>
      ...
      <main>
        <section className="steps" style={{ paddingTop: 50 }}>
          ...
          <div className="step" onClick={() => alert('Step 3: Service')}>
            ...
            <p>Our team will provide professional Gardening services</p>
