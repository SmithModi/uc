    ...
    <div style={{ paddingTop: 5 }}>
      <header>
        ...
        <Container maxW="full" p={4}>
          ...
          >
            <Box>
              <Heading>Home Care Service</Heading>
            </Box>
            <Box>
              <HCS />
            </Box>
        ...
        <h1>How it works</h1>
        <p>Learn about our home care service process</p>
      </header>
      ...
      <main>
        <section className="steps" style={{ paddingTop: 50 }}>
          ...
          <div className="step" onClick={() => alert('Step 3: Service')}>
            ...
            <p>Our professional caregivers will arrive at your home</p>
