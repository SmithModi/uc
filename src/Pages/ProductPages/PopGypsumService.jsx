    ...
    <div style={{ paddingTop: 5 }}>
      <header>
        ...
        <Container maxW="full" p={4}>
          ...
          >
            <Box>
              <Heading>Pop Gypsum Service</Heading>
            </Box>
            <Box>
              <PGS />
            </Box>
        ...
        <h1>How it works</h1>
        <p>Learn about our Pop Gypsum service process</p>
      </header>
      ...
      <main>
        <section className="steps" style={{ paddingTop: 50 }}>
          ...
          <div className="step" onClick={() => alert('Step 3: Service')}>
            ...
            <p>Our team will provide professional Pop Gypsum installation</p>
...
export default PopGypsumService;
