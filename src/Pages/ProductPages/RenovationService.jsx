      ...
      <header>
        ...
        <Container maxW="full" p={4}>
          <Grid templateColumns={{ base: "repeat(1, 1fr)", lg: "repeat(2, 1fr)" }} justifyContent="center" alignItems="center">
            <Box>
              <Heading>Renovation Service</Heading>
            </Box>
            <Box>
              <RS />
            </Box>
        ...
        <h1>How it works</h1>
        <p>Learn about our Renovation service process</p>
      </header>
      ...
      <main>
        <section className="steps" style={{ paddingTop: 50 }}>
          ...
          <div className="step">
            ...
            <p>We'll plan the renovation according to your needs</p>
          </div>
          <br />
          <div className="step">
            <h2>Step 3: Execution</h2>
            <p>Our team will execute the renovation seamlessly</p>
          </div>
          <br />
